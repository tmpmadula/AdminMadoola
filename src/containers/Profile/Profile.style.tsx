...
export const ProfileCardWrapper = styled("div", ({ $theme }) => ({
  height: "100%",
  width: "100%",
  borderRadius: "5px",
  borderColor: "#fff",
...
export const ProfileTitle = styled("h3", ({ $theme }) => ({
...
export const ProfileWeight = styled("span", ({ $theme }) => ({
...
export const ProfileMeta = styled("div", ({ $theme }) => ({
  marginTop: "15px",
  display: "flex",
  alignItems: "center",
...
export const ProfilePriceWrapper = styled("div", ({ $theme }) => ({
  display: "flex",
  alignItems: "center",
  position: "relative",
}));

export const ProfilePrice = styled("span", ({ $theme }) => ({
  ...$theme.typography.fontBold14,
...
export const ProfileViewInfo = styled("span", ({ $theme }) => ({
  background: "#f3f3f3",
  margin: "-20px",
...
export const ProfileViewTitle = styled("span", ({ $theme }) => ({}));
export const ProfileViewWeight = styled("span", ({ $theme }) => ({}));
...
export const ProfileViewPriceWrapper = styled("span", ({ $theme }) => ({}));
export const ProfileViewPrice = styled("span", ({ $theme }) => ({}));

export const ProfileViewHeader = styled("span", ({ $theme }) => ({
  background: "#f3f3f3",
  padding: "30px 0",
}));
/*
<ProfileViewInfo>
<ProfileViewTitle>Madula</ProfileViewTitle>
<ProfileViewWeight>10</ProfileViewWeight>
<ProfileViewMeta>
  <ProfileViewPriceWrapper>
    <ProfileViewPrice>R100</ProfileViewPrice>
  </ProfileViewPriceWrapper>
</ProfileViewMeta>
</ProfileViewInfo*/
