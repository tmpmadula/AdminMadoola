...
export const CreaterCardWrapper = styled("div", ({ $theme }) => ({
  height: "100%",
  width: "100%",
...
export const CreaterImageWrapper = styled("div", ({ $theme }) => ({
  height: "240px",
  padding: "5px",
  position: "relative",
...
export const CreaterInfo = styled("div", ({ $theme }) => ({
...
export const CreaterTitle = styled("h3", ({ $theme }) => ({
...
export const CreaterWeight = styled("span", ({ $theme }) => ({
...
export const CreaterMeta = styled("div", ({ $theme }) => ({
  marginTop: "15px",
  display: "flex",
  alignItems: "center",
...
export const CreaterPriceWrapper = styled("div", ({ $theme }) => ({
  display: "flex",
  alignItems: "center",
  position: "relative",
}));

export const CreaterPrice = styled("span", ({ $theme }) => ({
  ...$theme.typography.fontBold14,
